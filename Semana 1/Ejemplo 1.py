...
# Defines a neural network with one dense (fully connected) layer.
# The layer has 1 output neuron, expects 3 input features, uses a sigmoid activation, and includes a bias.
